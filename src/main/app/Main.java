	...
	public static void main(String[] args) throws ORMObjectException {
		...
		try {
	        ...
	        if (cmd.equals("get_studs")==true){
				...
				System.out.print("id"+ "  "+ " |" + "  " + "Name "+ "  "+ " |"+" Surname" + "\n");			
				Collection<Student> students = db.getStudents().getAll();
				for (Student st : students) {
					System.out.print(st.getID()+ "  "+ " |" + "  " + st.getName() + " |" + st.getSurname()  + "\n");			
				}
				System.out.print("ok" + "\n");
	        }
	        ...
	        if (cmd.equals("get_subj")==true){
				...
				for (Subject subj : subjects) {
					System.out.print(subj.getID()+ "  "+ " |" + "  " + subj.getSubjName()+ "\n");			
				}
				System.out.print("ok" + "\n");
	        }
			...
			System.out.print("ok" + "\n");
			System.out.print(">cmd" + "  " + "'Get group'" + "\n");
			System.out.print("----" + "  " + "Groups"+ "  " + "----" + "\n");
			System.out.print("id"+ "  "+ " |" + "  " + "Name " + "\n");
			db.getGroups().insert(group1);
			db.getGroups().insert(group2);
			...
			System.out.println(db.getStudents().getByID(2));
			//Mark mark = new Mark (subject1.getID(),student1.getID(),5);
			//db.getStudents().AddMark(mark);
			//	db.getStudents().remove(2);
			Collection<Student> students = db.getStudents().getAll();
			for (Student st : students) {
			...
			//db.getGroups().addStudent(group, student1);
			Group group1  = db.getGroups().getByName("IF36d");
			Student st = db.getStudents().getByID(1);
