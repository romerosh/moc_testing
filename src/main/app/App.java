			...
			while (true) {
				...
				if (cmd.equals("add_group") == true) {
					try {
						...
						log.info("The group '" + gr + "' was added");
					} catch (Exception e) {
				...
				if (cmd.equals("remove_group") == true) {
					try {
						...
						if (group == null) {
							System.out
									.print("INFO: Faied! The group was not found!\n");
							continue;
						}
				...
				if (cmd.equals("get_all_in_group") == true) {
					try {
						...
						Collection<Student> students = db.Groups()
								.getAllByGroup(group);
				...
				if (cmd.equals("remove_stud") == true) {
					try {
						...
						if (student == null) {
							System.out
									.print("INFO: Failed! Student was not found. \n");
							continue;
						}
				...
				if (cmd.equals("remove_subj") == true) {
					try {
						...
						if (subject == null) {
							System.out
									.print("INFO: Failed! Subject was not found. \n");
							continue;
						}
				...
				if (cmd.equals("avg_mark_group") == true) {
					try {
						...
						// double avg =
						// db.Groups().getAverageMark(group.getID());
				...
				if (cmd.equals("help") == true) {
					System.out
							.print("add_group - Добавляет группу в список.\n");
					System.out
							.print("get_groups - Выводит список всех созданных групп.\n");
					System.out.print("remove_group - Удаляет группу.\n");
					System.out
							.print("update_group - Меняет название группы.\n");
					System.out
							.print("get_all_in_group - Выводит список всех студентов в данной группе.\n");
					System.out
							.print("add_stud - Добавляет студента в список.\n");
					System.out
							.print("get_studs - Выводит список всех студентов.\n");
					System.out
							.print("remove_stud - Удаляет студента из списка.\n");
					System.out.print("update_stud - Меняет имя студента.\n");
					System.out.print("add_subj - Добавляет новый предмет.\n");
					System.out
							.print("get_subj - Выводит список всех созданных предметов.\n");
					System.out
							.print("remove_subj - Удаляет предмет из спика.\n");
					System.out
							.print("update_subj - Меняет название предмета.\n");
					System.out
							.print("add_mark - Добавляет оценку выбранному студенту по конкретному предмету.\n");
					System.out
							.print("get_marks - Выводит список всех оценок.\n");
					System.out
							.print("add_stud_to_group - Добавляет студента в группу.\n");
					System.out
							.print("remove_stud_from_group - Удаляет студента из группы.\n");
					System.out
							.print("avg_mark_group - Средняя оценка по группе.\n");
					System.out
							.print("avg_mark_stud - Средняя оценка по студенту.\n");
					System.out
							.print("get_stud_marks - Выводит все оценки студента.\n");
					return;
				}
				System.out
